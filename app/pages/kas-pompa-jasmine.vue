...
// Meta tags
useHead({
  title: "Kas Pompa Jasmine - Treasury Management",
});
...
const kasPompaRenjanaData = reactive<KasPompaRenjana[]>([]);

const {
  data: kasPompaRenjanaResponse,
  pending: isLoading,
  error,
} = await useFetch<SheetResponse<KasPompaRenjana[]>>("/api/gsheet", {
  query: { sheet: "Kas Pompa Jasmine" },
  transform: (data) => {
...
if (error.value) {
  showError();
} else if (kasPompaRenjanaResponse.value) {
  kasPompaRenjanaData.splice(
    0,
    kasPompaRenjanaData.length,
    ...kasPompaRenjanaResponse.value.data,
  );
}
</script>
    ...
    <div class="max-w-7xl mx-auto py-4 px-3 sm:py-6 sm:px-4 lg:px-6">
      ...
      <div class="mb-6">
        ...
        <p class="text-gray-600 dark:text-gray-400">
          Detail transaksi kas pompa Jasmine
        </p>
      </div>
      ...
      <UCard>
        <template #header>
          <div class="flex items-center justify-between">
            <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100">
              Data Transaksi Kas Pompa Jasmine
            </h3>
            <div
              class="flex items-center space-x-2 text-sm text-gray-500 dark:text-gray-400"
            >
              <UIcon name="i-mdi-table" class="w-4 h-4" />
              <span>{{ kasPompaRenjanaData.length }} transaksi</span>
            </div>
          </div>
        </template>
        ...
        <div class="hidden lg:block overflow-x-auto">
          ...
          >
            ...
            >
              ...
              <tr
                v-for="(transaction, index) in kasPompaRenjanaData"
                :key="index"
        ...
        <div class="lg:hidden space-y-4">
          ...
          <div
            v-if="!isLoading && kasPompaRenjanaData.length === 0"
